 ...
 * Used to notify screen reader users of dynamic content changes,
 * loading states, errors, and success messages.
 * 
 * @accessibility
 ...
 * Use the useAnnouncer hook or AnnouncerContext to make announcements.
 * 
 * @example
 * ```tsx
 * // In your root layout
...
export const AnnouncerProvider: React.FC<AnnouncerProviderProps> = ({
  ...
  const announce = useCallback(
    (message: string, priority: AnnouncementPriority = 'polite'): void => {
      ...
      setAnnouncements(historyRef.current);
